...
Invalid package IDs, object IDs, or partner addresses throw `TypeError` during client setup. Non-string partner values passed from JavaScript also throw `TypeError` with an `Invalid partner address configuration` message.
